...
class Guitarist extends Musician {
	...
	constructor(name, instrument, band) {
		...
		// this.#instrument = super(instrument);
...
class SongWriter {
	...
	addSongs = newSong => this.songs.push(newSong);
	...
	info = () => console.log(`Написав ${this.#songs.length} пісень`);
}
 ...
 * | band        | "Led Zeppelin"    |
 */
const guitarist = new Guitarist("Jimmy Page", "guitara", "Led Zeppelin");
/*
